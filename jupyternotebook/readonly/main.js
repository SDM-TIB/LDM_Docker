define([
    ...
    function delete_tools () {
        // Menu Item: insert cell above
        $('#insert_cell_above').remove();
        // Menu Item: insert cell
        $("#menu-cell-toolbar").remove();
        // Menu: Insert
        $("#insertlink").remove();
        // Menu: Edit
        $("#editlink").remove();
        // Menu: File
        $("#filelink").remove();
        // Tool box: insert cell
        $("#insert_above_below").remove();
        // Tool box: save notebook
        $("#save-notbook").remove();
        // Tool box: command palette
        $("#cmd_palette").remove();
        // Notebook title
        $("#notebook_name").hide();
