...
dataset_types_served = ['dataset', 'service']
...
class DOIPlugin(SingletonPlugin, toolkit.DefaultDatasetForm):
    ...
    def after_create(self, context, pkg_dict):
        ...
        '''
        if pkg_dict['type'] in dataset_types_served:
    ...
    def after_update(self, context, pkg_dict):
        ...
        if pkg_dict.get('state', 'active') == 'active' and not pkg_dict.get('private', False) and pkg_dict['type'] in dataset_types_served:
